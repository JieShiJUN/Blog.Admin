        ...
        <el-form ref="infoForm" :model="infoForm" :rules="rules" label-width="120px">
         ...
         <el-form-item label="分类" prop="bcategory">
          ...
          <el-form-item label="父导航" prop="bparentId">
            <el-input v-model="infoForm.Father.btitle"></el-input>
          </el-form-item>
          ...
          <el-form-item label="相关推荐" prop="StarList">
            <el-select v-model="infoForm.bstarList" multiple filterable>
              <el-option
                v-for="(item, index) in infoForm.StarList"
                :key="index"
                :label="item.btitle"
                :value="item.btitle"
                :selected="true"
          ...
          <el-form-item label="展示图" prop="bimage">
            ...
            >
              <img v-if="bimage" :src="bimage" class="avatar" />
